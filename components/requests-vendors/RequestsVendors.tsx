                   ...
                   <div className="flex-1">
                      <div className="flex justify-between items-start mb-2">
                         ...
                         <div className={`px-2 py-0.5 text-[10px] font-bold uppercase rounded-full border ${
                             req.priority === 'HIGH' || req.priority === 'CRITICAL' ? 'bg-red-50 text-red-600 border-red-100' : 
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3 bg-slate-50 p-3 rounded-lg border border-slate-100">
                             ...
                             <div>
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <span className={`inline-flex self-start items-center px-2 py-0.5 rounded text-[10px] font-bold uppercase ${
             ...
             <div className="bg-white rounded-xl shadow-xl w-full max-w-lg animate-in fade-in zoom-in-95 duration-200">
                 ...
                 <form onSubmit={handleRequestSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <FileUpload onFileSelect={(file) => setRequestForm({...requestForm, image: URL.createObjectURL(file)})} label="" />
                    </div>

                    <div className="pt-4 flex gap-3">
                        <button type="button" onClick={() => setIsRequestModalOpen(false)} className="flex-1 px-4 py-2 border rounded-lg">Cancel</button>
                        <button type="submit" className="flex-1 px-4 py-2 bg-secondary text-white rounded-lg">Submit Request</button>
                    </div>
                 </form>
             </div>
          </div>
