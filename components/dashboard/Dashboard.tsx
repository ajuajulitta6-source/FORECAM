...
import { WorkOrderStatus, WorkOrderPriority, UserRole, RequestStatus, WorkRequest } from '../../types';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, LineChart, Line } from 'recharts';
import { AlertTriangle, CheckCircle, Package, Clipboard, Wrench, Clock, Activity, Calendar, Camera, Send, MapPin, FileText, HardHat, Building } from 'lucide-react';
import toast from 'react-hot-toast';
import FileUpload from '../ui/FileUpload';

const Dashboard: React.FC = () => {
  const { workOrders, assets, inventory, updateWorkOrder, addRequest, requests } = useContext(DataContext);
  ...
  // --- ADMIN / TECHNICIAN VIEW (Existing Code) ---
